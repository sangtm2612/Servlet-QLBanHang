	...
	<tbody>
		<c:forEach items="${listBill }" var="bill">
			<tr>
				...
				<td>${ bill.ghiChu }</td>
				<td class="fw-bold ${ bill.trangThai == 0 ? 'text-secondary' : bill.trangThai == -1 ? 'text-danger' : bill.trangThai == 1 ? 'text-success' : ''}">${ bill.trangThai == 0 ? 'Chờ xác nhận' : bill.trangThai == 1 ? 'Hoàn thành' : bill.trangThai == -1 ? 'Đã hủy hóa đơn' : ''  }</td>
				<td><a class="btn btn-primary" href="/SANGTM_PH17730_ASM/home/bill/view?id=${bill.id }">Xem chi tiết</a></td>
				<td><a class="btn btn-primary ${bill.trangThai == -1 || bill.trangThai == 1 ? 'disabled' : '' }" href="/SANGTM_PH17730_ASM/bill/confirm?id=${bill.id }">Xác nhận</a></td>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <a class="btn btn-danger" href="/SANGTM_PH17730_ASM/bill/cancel?id=${bill.id }">Xác nhận</a>
					      </div>
					    </div>
					  </div>
					</div>
